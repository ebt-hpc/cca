...
class Outline(OutlineFortran):
    ...
    def setup_lctl_tbl(self):
        self.message('setting up loop control table...')
    ...
    def gen_data(self, lang, outdir='.', keep_rev=False):
        ...
        self.message('%d root nodes (units that contain loops) found' % count)
